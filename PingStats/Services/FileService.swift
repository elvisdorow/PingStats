...
class FileService {
    ...
    func sessionToText(sessionTextFile: SessionTextFile) -> String {
        ...
        \(NSLocalizedString("Generated by PingStats.app", comment: "")) v\(appVersion)
        ...
        \(NSLocalizedString("Package Loss", comment: "")): \(Formatter.number(sessionTextFile.packageLoss, fraction: 1, unit: "%"))
